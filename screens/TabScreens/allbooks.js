...
const AllBooks = () => {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      const q = query(booksRef, where('inLibrary', '==', true), where('userId', '==', user.uid));
  ...
  const handleSearch = () => {
    ...
    if (user) {
      const booksRef = collection(FirestoreDB, 'books');
      const q = query(booksRef, where('inLibrary', '==', true), where('bookName', '==', searchText), where('userId', '==', user.uid));
  ...
  const handleSortByAuthor = () => {
    ...
    if (user) {
      const booksRef = collection(FirestoreDB, 'books');
      const q = query(booksRef, where('inLibrary', '==', true), where('userId', '==', user.uid), orderBy('authorName'));
